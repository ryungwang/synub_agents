...
public class GitHubIssueSyncService {
    ...
    public GitHubSyncResult syncReadyIssues() {
        ...
        auditLogService.record("SYSTEM", "github-sync", "GITHUB_READY_ISSUES_SYNCED", "REPOSITORY", repository, "created=" + created + ", seen=" + issues.size());
        return new GitHubSyncResult(issues.size(), created);
    }
    ...
    public record GitHubSyncResult(int seen, int created) {
    }
}
